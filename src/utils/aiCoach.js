...
export const AVAILABLE_MODELS = [
  {
    ...
    description: 'Best balance of quality and size. Code-specialized model trained on 5.5T code tokens. Strong JavaScript understanding. ~1.8 GB download.',
  ...
  },
  {
    ...
    description: 'Smallest code-specialized option. Fast and lightweight for quick hints. ~639 MB download.',
  ...
  },
  {
    ...
    description: 'Highest code quality. Near GPT-3.5 level for JavaScript. ~3.4 GB download. Requires a capable device.',
